...
-- CreateTable
CREATE TABLE "AtividadeMinisterio" (
    "id" TEXT NOT NULL,
    "atividade_id" TEXT NOT NULL,
    "ministerio_id" TEXT NOT NULL,

    CONSTRAINT "AtividadeMinisterio_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "AtividadeMinisterio" ADD CONSTRAINT "AtividadeMinisterio_atividade_id_fkey" FOREIGN KEY ("atividade_id") REFERENCES "Atividade"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AtividadeMinisterio" ADD CONSTRAINT "AtividadeMinisterio_ministerio_id_fkey" FOREIGN KEY ("ministerio_id") REFERENCES "Ministerio"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
